...
export class Helpers {
    static arrayToRequestBody(data: Array<[string, any]>): string {
        let output: string = '';
    ...
    static prepareAuthenticationBody(userAuth: string, loginAuth: string): string {
        let output = Base64.encode(userAuth + ':' + loginAuth);
